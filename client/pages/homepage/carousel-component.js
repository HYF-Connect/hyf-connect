    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          ...
          <p class="slide__description">Helpy is a sharing platform, its goal is to link those people who need help <br> with their groceries to volunteers who are willing to help.</p>
        </div>
        <div class="carousel-item">
